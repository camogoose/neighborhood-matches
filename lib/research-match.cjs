...
a source supports travel time and mode. Do not quote long passages. Return ONLY JSON.
Every evidenceUrls entry must be an actual URL you consulted and that supports the claim.`;
